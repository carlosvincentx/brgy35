...
$query = "SELECT password FROM resident_account WHERE id = $id";
...
if (password_verify($oldPassword, $storedPassword)) {
    ...
    // Update query
    $query = "UPDATE resident_account SET username = '$username', email = '$email', password = '$hashedPassword' WHERE id = $id";
...
$query = "SELECT * FROM resident_account WHERE id = '$searched_user_id'";
$result = mysqli_query($conn, $query);

$user_data = json_decode($class->get_user_data($_SESSION['user_id']));
if ($user_data->status) {
    $user = $user_data->data;
