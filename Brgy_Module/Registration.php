...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($register->status == 'success') {
        ...
        $login = json_decode($class->login($email, $password));
				...
				<div class="card-body py-2">
					<div class="container-fluid">
                        ...
                        <?php endif; ?>
							...
							<br>
							<div class="form-group">
							<input size="40" type="email" name="email" id="email" class="form-control rounded-0" placeholder="Email" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" autofocus required pattern="^(?!.*@gmail\.com).*$">
	</div>
							<br>
							<div class="form-group">
