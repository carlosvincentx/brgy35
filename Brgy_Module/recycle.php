...
<section class="home-section" >
    ...
    <div class="container my-5 text-center" style="background-color:rgba(73,73,73, 0.9);">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if($selection == "All"){
    ...
    $sql = "SELECT * FROM head_family_restore, rbi WHERE head_family_restore.rbi_id = rbi.rbi_id LIMIT $offset, $records_per_page";
    ...
    while ($row = $result->fetch_assoc()) {
      echo "
        <tr>
          ...
          <a class='btn btn-danger btn-sm' href='restore.php?household_no=$row[head_id]'>Restore</a>
          </td>
        </tr>
      ";
    }
    
    $total_records_sql = "SELECT COUNT(*) FROM head_family_restore";
    ...
    if ($page > 1) {
      echo "<li class='page-item'><a class='page-link' href='rbi.php?page=" . ($page - 1) . "'>&laquo; Previous</a></li>";
    }
    for ($i = 1; $i <= $total_pages; $i++) {
      echo "<li class='page-item " . ($page == $i ? 'active' : '') . "'><a class='page-link' href='rbi.php?page=$i'>$i</a></li>";
    }
    if ($page < $total_pages) {
      echo "<li class='page-item'><a class='page-link' href='rbi.php?page=" . ($page + 1) . "'>Next &raquo;</a></li>";
    }
    echo "</ul>";
    ...
    $sql = "SELECT *
            FROM head_family_restore, rbi
            WHERE head_family_restore.rbi_id = rbi.rbi_id";
...
$sql_count = "SELECT COUNT(*) FROM head_family_restore, rbi WHERE head_family_restore.rbi_id=rbi.rbi_id";
