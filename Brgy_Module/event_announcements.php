...
<section class="home-section" style = "height:inherit;">
    ...
    <a class ="btn btn-primary btn-sm btn-block col-md-3 " href="create_event.php" role = "button"><span class="fa fa-plus"></span> Add General Announcement</a>
                    ...
                    <div class='card mb-5' style='border-radius: 15px;'>
                      <div style='background-color: #494949;border-radius: 10px;'class='card-body p-4'>
                        ...
                        <h3 style='color: white'class='mb-3'>$row[about]</h3>
                         <a class='btn btn-primary btn-sm mb-3' href='event/edit.php?household_no=$row[event_id]'>Edit</a>
                      <a class='btn btn-danger btn-sm mb-3' href='delete_event.php?household_no=$row[event_id]'>Delete</a>
                      <input type='text' value='https://brgy35.infinityfreeapp.com/Brgy_Module/eventPage.php?id=$row[event_id]' id='dataInput' hidden>
                   
                      <button onclick='copyData(this)' class='btn btn-primary btn-sm mb-3'>Copy</button>
                      
                      <script>
                        function copyData(button) {
                          var dataInput = button.previousElementSibling;
