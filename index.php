...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $class = new MainClass(); // Create an instance of the MainClass
    $login = json_decode($class->login());

    if ($login->status == 'success') {
        if ($_SESSION['typeAccount'] == "resident") {
            echo "<script>location.href='Resident_Module/auto.php';</script>";
            exit();
        } elseif ($_SESSION['typeAccount'] == "barangay") {
            echo "<script>location.href='Brgy_Module/auto.php';</script>";
            exit();
        }
    }
}
...
<head>
    ...
    <link rel="icon" href="../Resident_Module/img/brgylogo.png">
        ...
        <div class="col-lg-4 col-md-8 col-sm-12">
            <div class="card shadow rounded-3">
                ...
                <div class="card-title text-center">
                    ...
                    <img src="../Resident_Module/img/brgylogo.png" height="30%" width="30%">
                </div>
                ...
                <div class="card-body py-0">
                    <div class="container-fluid">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                            ...
                            <br>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary bg-gradient rounded-0">LOGIN</button>
                            </div>
                            <br>
                            <div class="form-group">
                                <p class="Inline">Not Registered in our Barangay Yet?</p>
                                <a href="Resident_Module/Registration.php" class="Inline">Register Here</a>
                            </div>
                        </form>
                    </div>
                </div>
